...
public class Eliminar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // NOTA: Se asume que activity_eliminar.xml fue actualizado con el botón "Button_Eliminar"
        setContentView(R.layout.activity_eliminar);

        rueliminar = findViewById(R.id.Eliminar);
        elim = findViewById(R.id.CheckBox_Eliminar); // Inicialización del botón
        ...
        elim.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Eliminar los elementos de la lista principal que están en listabaja
                // Esto funciona correctamente porque ambas listas contienen objetos de tipo 'producto'
